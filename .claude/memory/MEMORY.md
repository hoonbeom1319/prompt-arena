...
- [프로젝트 상태](project_state.md) — 완료 작업 및 미해결 항목 스냅샷 (2026-06-17, 아키텍처 리팩토링 **P0~P6 전부 완료**. lib 도메인 분해(ai·challenge·coin·quiz)+컴포넌트 colocation+토큰 2벌 구조 정정+hooks/ 미생성 결정. docs/ARCHITECTURE.md 단일 출처. **A-9 코인경제 모니터링은 홀드**)
