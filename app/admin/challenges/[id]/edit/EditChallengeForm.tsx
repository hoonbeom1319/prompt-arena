...
interface EditChallengeFormProps {
  challengeId: string
  initialForm: ChallengeForm
}

// 챌린지 수정 폼 island. 기존 값은 서버에서 props로 받는다.
// 수정은 PATCH /api/admin/challenges/[id] 경유 — supabase 직접 호출 없음 (ARCHITECTURE §2).
export default function EditChallengeForm({ challengeId, initialForm }: EditChallengeFormProps) {
